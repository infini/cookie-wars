...
- APK: [`artifacts/cookie-wars-v1.0.5.apk`](artifacts/cookie-wars-v1.0.5.apk)
...
- 길이 없는 넓은 잔디 전장에서 진행되는 거대 보스 1 대 다수 전투
...
- 도로·진입로 없이 하나의 잔디 공간으로 구성한 중세 쿠키 왕국 보스 맵
- 각 전투 최초 클리어마다 받는 화면 1/3 크기의 30배 거대 원반 1개
