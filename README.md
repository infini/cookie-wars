...
- APK: [`artifacts/cookie-wars-v1.0.2.apk`](artifacts/cookie-wars-v1.0.2.apk)
...
- easy 28마리부터 extreme god 170마리까지 이어지는 연속 침공
- 졸개·정예·중장갑·원거리·보스가 섞이는 데이터 기반 적 웨이브
- 난이도별 적 수, HP·공격력·이동 속도와 적 원반 레벨 상승
- 중세 쿠키 왕국 전투 맵과 고품질 3D 성·봇·적 이미지
