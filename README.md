...
- APK: [`artifacts/cookie-wars-v1.0.13.apk`](artifacts/cookie-wars-v1.0.13.apk)
- APK 크기: 103,158,090바이트 (98.38MiB)
- SHA-256: `651b1b0bc873524257616223d8bfb73ed80c501b43472752707159f2b7459968`
...
- 화면에 표시되는 데이터 기반 강화 4종, 진화 기여 플래그와 기존 크기 레벨의 1회 저장 이전
...
- 저장 스키마 v10과 전투 속도·쿠키 크리티컬 강화 진행의 안전한 복구
