...
- APK: [`artifacts/cookie-wars-v1.0.12.apk`](artifacts/cookie-wars-v1.0.12.apk)
- APK 크기: 104,346,034바이트 (99.51MiB)
- SHA-256: `9698236bfe8ccc1e8d8a5eca82146ed105f48f1ee003fc622a66889281402571`
...
- 별도 경험치 없이 진화 기여 강화 레벨과 기존 저장 보너스의 합계로 자동 진화하는 30종 쿠키
- 기본 확률 1%·획득량 10배의 쿠키 크리티컬과 확률 50% 상한·배수 무제한의 무한 강화
- 크리티컬 순간의 붉은 폭발 이펙트와 Mixkit `Short explosion` 고품질 WAV 효과음
...
- [`docs/CODE_REVIEW.md`](docs/CODE_REVIEW.md): 1.0.12 코드 리뷰 결과, 해결 사항과 후속 점검
