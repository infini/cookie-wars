...
클릭 힘은 Lv.1에서 50으로 시작하고 명시된 Lv.8의 400까지 매 단계 +50, 이후에도 레벨마다 +50이며 비용은 ×1.25로 증가합니다. 기존 저장은 레벨만 보관하므로 현재 단계에 맞는 새 클릭 힘이 즉시 적용되고, 크리티컬·조각 보상도 이 최종 클릭 힘을 기준으로 계산합니다.
