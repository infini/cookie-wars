...
export const styles = StyleSheet.create({
  ...
  battleSpeedButton: { minWidth: 42, alignItems: 'center', backgroundColor: 'rgba(255,190,45,0.94)', borderWidth: 2, borderColor: colors.white, borderRadius: 12, paddingHorizontal: 8, paddingVertical: 4, elevation: 4 },
  battleControlGroup: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  battleSpeedButtonPressed: { transform: [{ scale: 0.92 }] },
  battleSpeedText: { fontFamily: fonts.extraBold, fontSize: 11, color: colors.ink },
  autoBattleButton: { minWidth: 58, alignItems: 'center', backgroundColor: 'rgba(72,76,89,0.9)', borderWidth: 2, borderColor: colors.white, borderRadius: 12, paddingHorizontal: 6, paddingVertical: 4, elevation: 4 },
  autoBattleButtonEnabled: { backgroundColor: 'rgba(28,170,92,0.94)' },
  autoBattleText: { fontFamily: fonts.extraBold, fontSize: 9, color: colors.white },
  ...
  autoBattleProgressText: { fontFamily: fonts.extraBold, fontSize: 11, color: colors.greenDark, marginTop: 9, textAlign: 'center' },
